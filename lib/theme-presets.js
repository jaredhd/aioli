...
export const PRESET_GLASS = {
  ...
  overrides: {
    ...
    // Text — darken muted for AA contrast on #f0f4ff (6.89:1)
    'semantic.text.muted': '#475569',
...
export const PRESET_NEUMORPHIC = {
  ...
  overrides: {
    ...
    // Text — darken muted for AA contrast on gray surfaces (6.39:1 on #e8ecf1)
    'semantic.text.muted': '#475569',

    // Intent colors — darken for AA on gray #e8ecf1 surfaces
    'semantic.color.primary.default': '#1d4ed8',   // blue.700 → 5.65:1 (was #2563eb 4.36:1 FAIL)
    'semantic.text.link': '#1d4ed8',               // match primary
    'semantic.color.warning.default': '#92400e',   // amber.800 → 5.98:1 (was #b45309 4.23:1 FAIL)
    'component.button.outline.text': '#1d4ed8',    // match primary for outline btn
...
export const PRESET_GRADIENT = {
  ...
  overrides: {
    // Button gradients — vibrant, WCAG AA verified (all stops ≥4.5:1 with white text)
...
export const PRESET_DARK_LUXURY = {
  ...
  overrides: {
    ...
    // Text — warm neutrals (WCAG AA verified on #0c0a09 page + #1c1917 card)
    'semantic.text.default': '#fafaf9',       // 18.92:1 / 16.74:1
    'semantic.text.secondary': '#a8a29e',     // 7.83:1 / 6.93:1
    'semantic.text.muted': '#918a85',         // 5.81:1 / 5.14:1 (was #78716c → 4.12:1 FAIL)
    'semantic.text.link': '#fbbf24',          // 11.83:1 / 10.48:1

    // Intent colors — use light shades for AA on dark surfaces
    ...
    // Outline/ghost buttons — use light text on dark bg
    'component.button.outline.text': '#60a5fa',    // blue.400 → 7.77:1 on #0c0a09
    'component.button.outline.border': '#60a5fa',
    'component.button.ghost.text': '#fafaf9',      // near-white → 18.92:1 (was #0f172a 1.11:1 FAIL)
    ...
    // Button — gold gradient (WCAG AA verified: dark text #0c0a09 on gold surfaces)
    'component.button.primary.bg': '#d97706',           // 6.20:1
    'component.button.primary.bgHover': '#b86e1b',      // 4.97:1 (was #b45309 → 3.93:1 FAIL)
    'component.button.primary.bgActive': '#c27e24',     // 5.93:1 (was #92400e → 2.79:1 FAIL)
    'component.button.primary.text': '#0c0a09',
    'component.button.primary.gradient': 'linear-gradient(180deg, #fbbf24 0%, #d97706 100%)',         // 11.83:1 → 6.20:1
    'component.button.primary.gradientHover': 'linear-gradient(180deg, #d97706 0%, #b86e1b 100%)',    // 6.20:1 → 4.97:1
